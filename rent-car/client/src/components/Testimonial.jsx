...
const Testimonial = () => {
 const testimonials = [
        { id: 1, name: "Emma Rodriguez", address: "Barcelona, Spain", image: "https://images.unsplash.com/photo-1633332755192-727a05c4013d?q=80&w=200", rating: 5, review: "I've rented cars from various companies, but the experience with CarRental was exceptional and the service was fantastic!" },
    ...
    return (
        <div className="flex flex-col items-center px-8 md:px-16 lg:px-24 pt-20 pb-30">
            <div className="flex flex-col justify-center items-center text-center">
                <h1 className="text-4xl md:text-[40px] font-bold p-4">What Our Customers Say</h1>
            ...
            <div className="flex flex-wrap items-center justify-center gap-6 mt-20 mb-10 px-8">
