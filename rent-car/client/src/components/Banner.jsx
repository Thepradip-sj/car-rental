...
const Banner = () => {
  return (
    ...
    jusify-between px-8 min-md:pl-14 pt-10 bg-gradient-to-r from-[#0558FE] to-[#A9CFFF] max-w-6xl mx-3 md:mx-auto rounded-2xl overflow-hidden">
        ...
        <img src={assets.banner_car_image} alt="car" className="h-[200px] w-[400px] mt-10"/>
    </div>
  )
}
