...
const Footer = () => {
  const links = [
        {
            title: "Products",
            items: [{ name: "Templates", href: "#" }, { name: "Components", href: "#" }, { name: "Icons", href: "#" }, { name: "UI Kits", href: "#" }],
        },
        {
            title: "Company",
            items: [{ name: "About Us", href: "#" }, { name: "Careers", href: "#" }, { name: "Blog", href: "#" }, { name: "Contact", href: "#" }],
        },
        {
            title: "Resources",
            items: [{ name: "Documentation", href: "#" }, { name: "Changelog", href: "#" }, { name: "Support", href: "#" }, { name: "API Reference", href: "#" }],
        }
    ]
    ...
    return (
        <>
            ...
            <footer className="bg-zinc-50 pt-15 p-10 mt-10 sm:px-6 md:px-8 lg:px-20">
                <div className="max-w-7xl mx-auto">
                    <div className="flex flex-col lg:flex-row gap-16 pb-12">
                        <div className="flex-1 max-w-full lg:max-w-[400px]">
                            <div className="mb-6">
                                <svg width="27" height="29" viewBox="0 0 27 29" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="m7.25 4.11 6 3.366 6-3.367m-12 20.176v-6.721l-6-3.367m24 0-6 3.367v6.72M1.61 7.67l11.64 6.54 11.64-6.54M13.25 27.25V14.197m12 5.18V9.017c0-.454-.124-.9-.358-1.293a2.63 2.63 0 0 0-.975-.947l-9.333-5.18a2.73 2.73 0 0 0-2.667 0l-9.333 5.18a2.63 2.63 0 0 0-.976.947 2.54 2.54 0 0 0-.358 1.293v10.36c0 .454.124.9.358 1.293s.57.72.976.947l9.333 5.18a2.73 2.73 0 0 0 2.667 0l9.333-5.18a2.63 2.63 0 0 0 .975-.947 2.53 2.53 0 0 0 .358-1.293" stroke="#000" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" /></svg>
                            </div>
                            <p className="text-sm leading-7 text-zinc-500 mb-7 max-w-80">
                                Premium car rental service with a wide selection of luxury and everyday vehicles for all your driving needs.</p>
                    ...
                    <div className="flex flex-col md:flex-row gap-6 md:gap-16 py-9 max-w-6xl">
                        ...
                        <div className="flex items-start gap-2.5 flex-1">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-zinc-500 leading-relaxed">contact@carRental.com</p>
                            </div>
                        </div>
                    </div>

                    <div className="flex flex-col md:flex-row justify-between items-center gap-4 py-4 border-t border-zinc-300">
                        <p className="text-sm text-zinc-500">&copy; {new Date().getFullYear()} carRental. All Right Reserved.</p>
